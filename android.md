---
layout: default
title: "Arc for Android — AI Screen Assistant | Free Download"
...
<div class="coming-soon-hero android-hero">
  ...
  <h1>Arc for Android</h1>
  <p class="hero-subtitle">The free AI screen assistant for Android. Summarize, read aloud, chat, write, and automate any app with one floating sidebar.</p>
</div>
...
<div class="coming-soon-features">
  <div class="features-grid">
    <div class="feature-card">
      ...
      <h3>AI Summary</h3>
      <p>Condense articles, messages, and web pages instantly with Google Gemini.</p>
    </div>
    <div class="feature-card">
      ...
      <p>Listen to any text with automatic language detection and natural TTS voices.</p>
    </div>
    <div class="feature-card">
    ...
    <div class="feature-card">
      ...
      <h3>AI Writer</h3>
      <p>Rewrite, reply, translate, or polish text in any app without copy-pasting.</p>
    </div>
    <div class="feature-card">
