...
Thank you for choosing Arc: AI Reader & Summary ("Arc", "we", "our", or "the App"). These Terms of Service ("Terms") govern your access to and use of Arc, our floating sidebar application that provides AI-powered summaries, text-to-speech, and content saving features for Android devices.
...
**Minimum Requirements:** Android 7.0 (API 24) or higher. Screenshot feature requires Android 11+.
...
**Google Sign-In (Optional):** For Drive backup and future premium features. We collect only your Google ID and email (no name or profile picture). You're responsible for account security and can delete your account anytime by contacting us.
...
| :--------- | :------ | :---------- |
| **Accessibility Service** | Read on-screen text and capture screenshots (with consent) | Only when you explicitly tap a sidebar action (AI Summary, AI Read, or Save Content). **Never** runs in the background or monitors your screen automatically. |
...
| **Internet / Network State** | Communicate with AI services, our backend, and load ads | When using AI features or Google Sign-In |
...
| **Media Projection (Android 11+)** | Capture screenshots when you tap "Save Content" | **Only when you grant explicit screenshot permission** and tap the save button. Never automatic. |
...
**Your Content:** You own all content you create or save. By using AI features, you grant us temporary rights to process your on-screen text solely for generating summaries. Backup content is subject to Google's terms.
...
We use Google Gemini API for summaries and your device's Text-to-Speech for audio. **Important:** AI summaries may not be 100% accurate and are for informational purposes only - not professional advice. Verify important information before relying on it.

---

## 7. Advertising

We display banner ads via Google AdMob for free users. We don't control ad content. Report inappropriate ads by contacting us. Ad-free premium plans may be offered in the future.
...
**By Us:** We may terminate access for Terms violations or illegal activity.

**After Termination:** Your right to use the app ends. Account data may be deleted per our Privacy Policy. Local device content remains until you delete it.
...
<div class="footer-section">
  <p><em>These Terms of Service are effective as of October 12, 2025.</em></p>
