---
layout: default
title: "Arc for Windows — AI Screen Assistant | Coming Soon"
description: "Arc for Windows is coming soon. Bring AI summaries, text-to-speech, chat, and workflow automation to every screen on your PC."
...
<div class="coming-soon-hero">
  ...
  <div class="coming-soon-icon icon-windows" aria-hidden="true">
  ...
  <h1>Arc for Windows</h1>
  <p class="hero-subtitle">The AI screen assistant is coming to Windows. Summarize, read aloud, chat, and automate across every desktop app.</p>
...
<div class="section-header">
  ...
  <h2>AI superpowers for your PC.</h2>
  <p>Arc on Windows will put a powerful AI sidebar on every screen, so you never have to switch apps to get things done.</p>
</div>
...
<div class="coming-soon-features">
  <div class="features-grid">
    <div class="feature-card">
      ...
      <p>Turn long browser tabs, documents, and chat threads into bite-sized takeaways instantly.</p>
    </div>
    <div class="feature-card">
      ...
      <h3>Read Aloud</h3>
      <p>Use Windows natural voices to listen to any text while you work on something else.</p>
    </div>
    <div class="feature-card">
      ...
      <p>Ask questions about what you see in any app and get instant, contextual answers.</p>
    </div>
    <div class="feature-card">
      ...
      <p>Browse, install, and share AI actions built by other Windows Arc users.</p>
    </div>
    <div class="feature-card">
      ...
      <h3>AI Writer</h3>
      <p>Rewrite, reply, translate, or polish text in any Windows app without copy-pasting.</p>
    </div>
    <div class="feature-card">
