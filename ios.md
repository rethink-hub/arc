---
layout: default
title: "Arc for iOS — AI Screen Assistant | Coming Soon"
description: "Arc for iOS is coming soon. Summarize, read aloud, chat, and automate your iPhone screen with a powerful floating AI sidebar."
...
<div class="coming-soon-hero">
  ...
  <h1>Arc for iOS</h1>
  <p class="hero-subtitle">The AI screen assistant you love, redesigned for iPhone. Summarize, chat, and automate without leaving any app.</p>
...
<div class="section-header">
  ...
  <h2>AI assistance made for iPhone.</h2>
  <p>Arc on iOS will sit at the edge of every app, ready to help you understand, write, and act faster.</p>
</div>
...
<div class="coming-soon-features">
  <div class="features-grid">
    <div class="feature-card">
      ...
      <p>Condense long articles, messages, and web pages right from your iPhone screen.</p>
    </div>
    <div class="feature-card">
      ...
      <p>Use natural iOS voices to read text aloud in any language while you multitask.</p>
    </div>
    <div class="feature-card">
      ...
      <p>Rewrite replies, fix grammar, and generate messages from any keyboard context.</p>
    </div>
    <div class="feature-card">
      ...
      <p>Create and run custom AI commands from the Dynamic Island or AssistiveTouch-style shortcut.</p>
    </div>
    <div class="feature-card">
      <div class="feature-icon icon-writer" aria-hidden="true">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20H21"/><path d="M16.5 3.5C16.8978 3.10217 17.4374 2.87868 18 2.87868C18.5626 2.87868 19.1022 3.10217 19.5 3.5C19.8978 3.89782 20.1213 4.43739 20.1213 5C20.1213 5.56261 19.8978 6.10217 19.5 6.5L7 19L3 20L4 16L16.5 3.5Z"/></svg>
      ...
      <h3>AI Writer</h3>
      <p>Rewrite replies, fix grammar, and generate messages in any iOS app without copy-pasting.</p>
    </div>
    <div class="feature-card">
